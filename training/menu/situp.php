...
<body>
    <div class="pushup-container">
        ...
        <div class="pushup-main">
            ...
            <form action="../logic/write_situp.php" method="POST">
                <input required class="number-form" name="situp_result" type="number" placeholder="回数" maxlength="2">
